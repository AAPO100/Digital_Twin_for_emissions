...
console.log('loading')
class HeatmapForEarthwork extends Autodesk.Viewing.Extension {
...
Autodesk.Viewing.theExtensionManager.registerExtension('HeatmapForEarthwork', HeatmapForEarthwork);
