...
export class EmissionsPanel extends Autodesk.Viewing.UI.DockingPanel {
    constructor(extension, id, title, options) {
        ...
        this.chartType = options.chartType || 'line'; // See https://www.chartjs.org/docs/latest for all the supported types of charts
    ...
    createChart() {
        return new Chart(this.canvas.getContext('2d'), {
            type: this.chartType,
            data: {
                labels: dataFromTesting,
                datasets: [{ data: dataFromTesting, backgroundColor: '#FF8C00', borderColor: '#FF8C00', borderWidth: '1' }],
            },
    ...
    //     const propertyNames = await this.extension.getDiagram(model);
